    ...
    <div className='pt-32 pb-20'>
      <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='grid lg:grid-cols-2 gap-16 p-6 rounded-2xl bg-[#110e0d]/90 backdrop-blur-md '>
          <div className=''>
            <h3 className='text-2xl font-bold mb-6 text-white'>{t("contact.form_title")}</h3>
            ...
            <div className='gap-6 grid'>
              ...
              <div className='flex items-start gap-4 p-4 hover:bg-[#1c1816]/50 transition duration-300 rounded-lg border-l-4 border-orange-500/70'>
                ...
                <div>
                  ...
                  <p className='text-sm text-gray-400 mt-1'>{t("contact.location_value")}</p>
                </div>
              </div>
              ...
              <div className='flex items-start gap-4 p-4 hover:bg-[#1c1816]/50 transition duration-300 rounded-lg border-l-4 border-orange-500/70'>
                ...
                <div>
                  ...
                  <p className='text-sm text-gray-400 mt-1'>{t("contact.email_value")}</p>
                </div>
              </div>
              ...
              <div className='flex items-start gap-4 p-4 hover:bg-[#1c1816]/50 transition duration-300 rounded-lg border-l-4 border-orange-500/70'>
                ...
                <div>
                  ...
                  <p className='text-sm text-gray-400 mt-1'>{t("contact.phone_value")}</p>
                </div>
              </div>
            </div>
          </div>
